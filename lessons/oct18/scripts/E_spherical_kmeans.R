...
# Words
dim(txtSKMeans$prototypes)
str(txtSKMeans$prototypes)

# Poor documentation: to id prototypical documents, use the prototypical terms and perform an inner join on each document, the highest overlap among docs *could* be the prototypical but this is my assertion, not supported by documentation.
?skmeans

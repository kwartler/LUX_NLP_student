...
# Ignore the Japanese; not the point of the effort
...
# Regex Explanation "^" anything but the 1-127th ASCII character is sub'ed to ""
# Yes I had to look that up :)
# This is only applied to two tweets but can be applied to the entire text easily.
...
# Keep in mind: This doesn't save the object but just needs a declaration to do so.
